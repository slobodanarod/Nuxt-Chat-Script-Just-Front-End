                    ...
                    <div class="main-section">
                        ...
                        <div class="all-search-events">
                            ...
                            <div class="row text-center" v-else>
                                <div class="col-lg-12 col-md-12">
                                    <p>Henüz kimse sana gülümsemedi. Seni görmelerini sağlamak için sohbet odalarına gir ve mesaj at</p>
                                </div>
                            </div>
    ...
    export default {
        ...
        }, mounted ()
        {
            ...
            get (page = 1)
            {
                ...
                axios.post("/api/actions/smiles/out?page=" + page, data).then((res) => {
